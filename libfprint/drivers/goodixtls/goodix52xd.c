...
G_GNUC_UNUSED static void rotate_frame(Goodix52xdPix frame[GOODIX52XD_FRAME_SIZE])
{
...
G_GNUC_UNUSED static void squash_frame(Goodix52xdPix* frame, guint8* squashed)
{
 ...
 * @param background
 */
G_GNUC_UNUSED static gboolean postprocess_frame(Goodix52xdPix frame[GOODIX52XD_FRAME_SIZE],
...
static void scan_run_state(FpiSsm* ssm, FpDevice* dev)
{
    ...
    case SCAN_STAGE_GET_IMG:
         ...
         * Mirrors the 53xd path; the original {0x05, 0x03} brace-init of a
         * scalar silently dropped the second byte. Unverified on 521d
         * hardware. */
